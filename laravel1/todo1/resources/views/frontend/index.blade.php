            ...
            <div class="header">
                <div class="header_resize">
                    ...
                    <div class="header_img">
                        <img src="{{ asset('frontend/images/header_img.jpg') }}" alt="" width="351" height="229" />
                    ...
                    <div class="mainbar">
                        @foreach($products as $product)
                            <div class="article">
                                ...
                                <img src="{{ asset('storage/'. $product->image) }}" style="max-width: 500px; height: auto;"  alt="" />
                                <h2>$ {{ $product->price }}</h2>
                                <div class="clr"></div>
                        ...
                        <div class="article">
                            ...
                            <div class="clr"></div>
                            <p>Posted on 18. Sep, 2015 by Sara in Filed under templates, internet, with Comments 18</p>
                            <img src="{{ asset('frontend/images/img_2.jpg') }}" width="613" height="179" alt="" />
                            <div class="clr"></div>
                    ...
                    <div class="sidebar">
                        <div class="search">
                            <form id="form" name="form" method="post" action="#">
                                ...
                                <input name="b" type="image" src="{{ asset('frontend/images/search.gif') }}" class="button" />
                            </form>
                        </div>
                        <!--/search -->
                        <div class="gadget">
                        ...
                        <div class="gadget">
                            <h2>Wise Words</h2>
                            <div class="clr"></div>
                            <p> <img src="{{ asset('frontend/images/test_1.gif') }}" alt="" width="19" height="20" /> <em>We can let circumstances rule us, or we can take charge and rule our lives from within </em>.<img src="{{ asset('frontend/images/test_2.gif') }}" alt="" width="19" height="20" /></p>
            ...
            <div class="fbg">
                <div class="fbg_resize">
                    <div class="col c1">
                        ...
                        <a href="#"><img src="{{ asset('frontend/images/gallery_1.jpg') }}" width="58" height="58" alt="" /></a> <a href="#"><img src="{{ asset('frontend/images/gallery_2.jpg') }}" width="58" height="58" alt="" /></a> <a href="#"><img src="{{ asset('frontend/images/gallery_3.jpg') }}" width="58" height="58" alt="" /></a> <a href="#"><img src="{{ asset('frontend/images/gallery_4.jpg') }}" width="58" height="58" alt="" /></a> <a href="#"><img src="{{ asset('frontend/images/gallery_5.jpg') }}" width="58" height="58" alt="" /></a> <a href="#"><img src="{{ asset('frontend/images/gallery_6.jpg') }}" width="58" height="58" alt="" /></a> </div>
                    <div class="col c2">
